...
void quadro::desenha(float referenciaX, float referenciaY){
    ...
    for(int i = 1; i <=3; i++){ //desenha as linhas que se ligam a catraca
...
torso::torso(float escala){
    ...
    float y = 1.5;                       //altura desejada para o ombro
...
void perna::desenha(){
    float angBancoPedal;
    float dist;
    angBancoPedal = calcAngulo(banco, pedal);
